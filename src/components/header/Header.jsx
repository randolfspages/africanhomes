  ...
  return (
    <div className="bg-white sticky top-0 left-0 right-0 z-[999999]">
      <div className="max-w-screen-2xl mx-auto py-4 px-5 flex justify-between items-center">
        ...
        {/* Contact Us Button */}
        <div className="hidden lg:block">
          <button className="text-[#0F0E0E] font-semibold border-2 border-[#BF712B] px-4 py-2 rounded-lg">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 bg-white shadow-md z-50 lg:hidden">
          <div className="flex justify-between items-center p-4 border-b">
            ...
            {/* Close Button */}
            <button onClick={toggleMenu}>
              <MdClose className="text-2xl text-[#BF712B]" />
            </button>
          </div>
          ...
          <div className="mt-6 text-center">
            <button className="flex items-center justify-center gap-2 border-2 border-[#BF712B] px-4 py-2 rounded-lg mx-auto">
              Contact Us
              <span>
                <img
                  src={arrowIcon}
