...
const RealEstateSection = () => {
    return (
        <div className="max-w-screen-2xl mx-auto lg:my-2 my-1 p-5">
                    ...
                    <div className="space-y-6">
                        <div className="max-w-md">
                            <h1 className="text-3xl lg:text-4xl font-bold leading-tight">
                                Building dreams into stunning <span className="text-[#3E1900]">real estate</span>
                            </h1>
                        </div>
                        <div className="max-w-md">
                        ...
                        <div className="mt-7 lg:mt-12">
                            <button className="px-6 py-3 border text-white border-[#3E1900] flex items-center gap-2 text-sm lg:text-base font-medium rounded-md transition-transform transform hover:scale-105">
                                More About Us
                                <img
                                    src={arrowIcon}
                                    alt="Arrow Icon"
