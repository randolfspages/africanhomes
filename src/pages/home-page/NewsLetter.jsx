            ...
            <div className="bg-[#fef6f3] p-8 flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="md:w-1/2">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4">
                        Find your <span className="text-[#BF712B]">dream home</span> today!
                    </h1>
                    ...
                    <a
                        href="#contact"
                        className="inline-flex items-center px-6 py-3 bg-white border border-[#BF712B] text-black font-medium rounded hover:bg-gray-100 transition"
                    >
                        Contact Us
