            ...
            <div className='max-w-screen-2xl container mx-auto px-5'>
                ...
                <div className='text-center mb-12'>
                    <h2 className='text-3xl lg:text-4xl font-bold text-gray-800'>
                        Find your home with <span className='text-[#F4B46D]'>unique preferences</span>
                    </h2>
                ...
                <div className='text-center mt-9 lg:mt-24'>
                    <button className='px-6 py-3 border mx-auto text-[#3E1900] border-[#F4B46D] flex items-center gap-2 text-sm font-medium rounded-md transition-transform transform hover:scale-105'>
