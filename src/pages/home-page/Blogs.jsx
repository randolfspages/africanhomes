    ...
    <section className='bg-white mb-10 py-28' id='blog'>
        <div className='max-w-screen-2xl container mx-auto px-5'>
            ...
            <div className='text-center mb-12'>
                <h2 className='text-3xl lg:text-4xl font-bold text-gray-800'>Our newest updates and <span className='text-[#BF712B]'>insights</span></h2>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
                ...
                <div className='border rounded-lg relative overflow-hidden shadow-lg hover:scale-105 transition-all duration-200 ease-in cursor-pointer'>
                    ...
                    <div className='p-4'>
                        ...
                        <h3 className='text-[#BF712B] text-[23px] font-semibold mb-3'>Essential tips for first-time home buyers: your complete guide</h3>
                    </div>
                </div>
            ...
            <div className='text-center mt-9 lg:mt-24'>
                    <button className='px-6 py-3 border mx-auto text-[#0F0E0E] border-[#BF712B] flex items-center gap-2 text-sm font-medium rounded-md transition-transform transform hover:scale-105'>
